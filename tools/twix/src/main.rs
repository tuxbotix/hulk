...
use panel::Panel;
use panels::{
    BehaviorSimulatorPanel, ImagePanel, ImageSegmentsPanel, LookAtLitePanel,
    ManualCalibrationPanel, MapPanel, ParameterPanel, PlotPanel, TextPanel,
};
...
impl SelectablePanel {
    ...
    fn try_from_name(name: &str, nao: Arc<Nao>, value: Option<&Value>) -> Result<SelectablePanel> {
        Ok(match name.to_lowercase().as_str() {
            ...
            "look-at lite" => SelectablePanel::LookAtLite(LookAtLitePanel::new(nao, value)),
    ...
    fn save(&self) -> Value {
        let mut value = match self {
            ...
            SelectablePanel::LookAtLite(panel) => panel.save(),
        };
...
impl Widget for &mut SelectablePanel {
    fn ui(self, ui: &mut Ui) -> eframe::egui::Response {
        match self {
            ...
            SelectablePanel::LookAtLite(panel) => panel.ui(ui),
        }
    }
}
...
impl Display for SelectablePanel {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        let panel_name = match self {
            ...
            SelectablePanel::LookAtLite(_) => LookAtLitePanel::NAME,
        };
